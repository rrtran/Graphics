...
public:
	...
	void render(double currentTime)
	{
		...
		drawElementsIndirectCommand.vertexCount = 45;
		drawElementsIndirectCommand.instanceCount = 1;
		drawElementsIndirectCommand.firstIndex = 0;
		drawElementsIndirectCommand.baseVertex = 0;
		drawElementsIndirectCommand.baseInstance = 0;

		GLuint drawElementsIndirectBuffer;
		glCreateBuffers(1, &drawElementsIndirectBuffer);
		glBindBuffer(GL_DRAW_INDIRECT_BUFFER, drawElementsIndirectBuffer);
		glBufferStorage(GL_DRAW_INDIRECT_BUFFER, sizeof(drawElementsIndirectCommand), &drawElementsIndirectCommand, 0);
		...
		//glDrawElementsBaseVertex(GL_TRIANGLE_STRIP, 45, GL_UNSIGNED_SHORT, 0, 0);
		//glDrawElementsInstanced(GL_TRIANGLE_STRIP, 45, GL_UNSIGNED_SHORT, 0, 1);
		//glDrawElementsInstancedBaseVertex(GL_TRIANGLE_STRIP, 45, GL_UNSIGNED_SHORT, 0, 1, 0);
		//glDrawElementsInstancedBaseInstance(GL_TRIANGLE_STRIP, 45, GL_UNSIGNED_SHORT, 0, 1, 0);
		//glDrawElementsInstancedBaseVertexBaseInstance(GL_TRIANGLE_STRIP, 45, GL_UNSIGNED_SHORT, 0, 1, 0, 0);
		...
		glDeleteBuffers(1, &drawElementsIndirectBuffer);
	}
